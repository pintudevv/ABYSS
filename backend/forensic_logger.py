"""
StealthOS — Forensic Logger (Step 6)
=====================================
...
def generate_text_summary(report: Dict[str, Any]) -> str:
    ...
    # header
    lines.append("+" + "=" * 70 + "+")
    lines.append("|         StealthOS -- Forensic Analysis Report" + " " * 23 + "|")
    lines.append("+" + "=" * 70 + "+")
    ...
    lines.append("  Generated by StealthOS Forensic Logger v2.0")
    lines.append(f"  Report ID: {_safe_str(meta.get('report_id'), 'N/A')}")
    lines.append("=" * 72)
    lines.append("")
...
def run(results_dir: Path, analyst_id: str, pretty_json: bool) -> int:
    ...
    log.info("StealthOS Forensic Logger v2.0 -- starting")
    ...
    print("\n" + "-" * 60)
    print(f"  StealthOS Forensic Report -- {verdict}")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="StealthOS Step 6 -- Forensic Report Builder",
